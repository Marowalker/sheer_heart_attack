...
from chatbot.core.nlp.data import preprocess, bot_data
from chatbot.core.nlp.models.model import BotModel, CardioModel

if not os.path.exists(constants.MODEL_PATH + constants.BOT_MODEL):
    words, classes, docs = preprocess.process(constants.DATA + constants.INTENT_FILE)
